    ...
    <div style={{ background: "var(--paper)", minHeight: "100vh" }}>
      <div style={{ maxWidth: 1240, margin: "0 auto" }}>
        ...
        <HeroEditorial
          ...
          decisionIntelligence={{ state: "too_close", recommendation: "Effectively tied — your airline and neighbourhood decide", summary: "JFK and Newark are separated by only 5 minutes of total journey time. The airport transfer does not decide this — your airline, schedule, and New York destination do.", advantages: ["JFK: more airlines and international routes","Newark: best rail connection to Midtown Manhattan","Both: comparable total journey time and cost"], tradeoffs: [{ advantage: "Newark's direct NJ Transit to Penn Station", disadvantage: "United-dominated — fewer airline choices" },{ advantage: "JFK's wide airline choice", disadvantage: "AirTrain transfer adds a step versus Newark's direct train" }], flips: [{ condition: "You fly United Airlines", result: "Newark becomes the default — United operates ~70% of flights" },{ condition: "You are staying in Brooklyn", result: "JFK is closer and better connected to Brooklyn" },{ condition: "You arrive after midnight", result: "JFK has 24-hour A subway; NJ Transit stops around 1am" }], limitations: [{ condition: "Flight schedule", impact: "A better-timed flight may override any airport preference" },{ condition: "Ticket price difference", impact: "A significantly cheaper fare to either airport should decide" }], unknowns: ["We do not have your exact destination in New York","We do not know your preferred airline","We do not know your arrival time"] }}
          evidence={{ factors: [
