    ...
    <div style={{ background: "var(--paper)", minHeight: "100vh" }}>
      <div style={{ maxWidth: 1240, margin: "0 auto" }}>
        ...
        <HeroEditorial
          ...
          decisionIntelligence={{ state: "recommended", recommendation: "Heathrow — in this illustrative worked example", summary: "In this scenario, the cheaper ticket produced the more expensive journey. This recommendation applies to the worked example on this page. Your own flights may produce a different result.", advantages: ["Complete journey cost reveals the cheaper ticket was misleading","Adding baggage, transfers and schedule costs changes the ranking","The method works for any two flights — apply it to your own"], tradeoffs: [{ advantage: "Lower total cost in this example", disadvantage: "Higher ticket price required more upfront payment" },{ advantage: "Faster door-to-door journey", disadvantage: "The cheaper-looking ticket remains tempting at first glance" }], flips: [{ condition: "Checked bag removed from the budget option", result: "The cost gap narrows or may reverse — the budget ticket can win" },{ condition: "Airport transfer becomes cheaper (e.g. booked in advance)", result: "The original low fare may regain the total-cost advantage" },{ condition: "Schedule cost removed (no late arrival penalty)", result: "The total changes — the budget option may become competitive" },{ condition: "Traveller assigns no monetary value to time", result: "The recommendation may become cost-only, ignoring the time saving" }], limitations: [{ condition: "Illustrative example only", impact: "Ticket prices, baggage fees and transfer costs are not live" },{ condition: "Hand-luggage-only travel", impact: "Changes the baggage cost assumption for both options" },{ condition: "Personal time value", impact: "The worked example includes a notional time value — yours may differ" }], unknowns: ["Your actual flight prices and dates","Your airline baggage policy for your specific fare class","Your exact transfer cost from each airport to your destination","Whether you value time in monetary terms"] }}
          evidence={{ factors: [
