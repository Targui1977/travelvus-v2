    ...
    <div style={{ background: "var(--paper)", minHeight: "100vh" }}>
      <div style={{ maxWidth: 1240, margin: "0 auto" }}>
        ...
        <HeroEditorial
          ...
          decisionIntelligence={{ state: "conditionally_recommended", recommendation: "Newark — for Midtown and West Side Manhattan", summary: "Newark is recommended for many Midtown and West Side journeys, but Manhattan is not one uniform destination. Your neighbourhood within Manhattan changes which airport wins.", advantages: ["NJ Transit direct to Penn Station — fastest rail to Midtown","Traffic-independent — rail is unaffected by Manhattan gridlock","Strong for West Side, Chelsea and Hudson Yards destinations"], tradeoffs: [{ advantage: "Best rail connection to Midtown", disadvantage: "In New Jersey — taxi surcharge and tolls add cost" },{ advantage: "United hub — seamless for United flyers", disadvantage: "Dominated by one airline — fewer choices for non-United travellers" }], flips: [{ condition: "Destination is Upper East Side", result: "LaGuardia becomes the stronger recommendation — closest taxi ride" },{ condition: "Destination is Downtown or Financial District", result: "JFK (A train direct) or Newark (NJ Transit then subway) — compare both" },{ condition: "Destination is Brooklyn or Queens", result: "JFK becomes the stronger recommendation — AirTrain + subway serves directly" },{ condition: "Arrival is after midnight", result: "JFK's 24-hour A subway becomes the decisive factor — NJ Transit stops ~1am" }], limitations: [{ condition: "Airline or route unavailable at Newark", impact: "Airport choice is constrained before transfer comparison matters" },{ condition: "Road traffic during rush hour", impact: "LGA's distance advantage can disappear — rail is more reliable" }], unknowns: ["Exact Manhattan address or cross-street","Preferred airline and frequent-flyer status","Arrival time and day of week","Willingness to use public transit vs taxi"] }}
          evidence={{ factors: [
