    ...
    <div style={{ background: "var(--paper)", minHeight: "100vh" }}>
      <div style={{ maxWidth: 1240, margin: "0 auto" }}>
        ...
        <HeroEditorial
          ...
          decisionIntelligence={{ state: "recommended", recommendation: "Heathrow — in this illustrative worked example", summary: "In this scenario, the shorter flight produced the longer door-to-door journey. This recommendation applies to the worked example. Your own flights may produce a different result.", advantages: ["Door-to-door comparison reveals the shorter flight was misleading","Adding airport access, waiting and transfers changes the ranking","The method works for any two flights — apply it to your own journey"], tradeoffs: [{ advantage: "Shorter total door-to-door time in this example", disadvantage: "The longer scheduled flight requires accepting more airtime" },{ advantage: "More direct airport access", disadvantage: "The perception that 'shorter flight = faster journey' is hard to overcome" }], flips: [{ condition: "Departure airport access becomes equal for both options", result: "Flight duration becomes a more important factor" },{ condition: "Arrival destination changes to one closer to the budget airport", result: "The final transfer may reverse the total-time winner" },{ condition: "Travelling with cabin baggage only", result: "Arrival processing becomes shorter for both options" },{ condition: "Public transport unavailable (late night / strike)", result: "Taxi or hotel requirement can change the total journey time" }], limitations: [{ condition: "Illustrative example only", impact: "Transfer times, queues and schedules are not live" },{ condition: "Actual airport queues", impact: "Security and immigration times vary by terminal, time and day" },{ condition: "Disruptions and strikes", impact: "Transport availability can change without notice" }], unknowns: ["Actual check-in and security queue times on your travel date","Real-time public transport schedules and disruptions","Your exact final destination and preferred transfer method","Whether schedule gaps exist for your specific flights"] }}
          evidence={{ factors: [
