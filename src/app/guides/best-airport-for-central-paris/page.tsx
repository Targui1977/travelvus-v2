    ...
    <div style={{ background: "var(--paper)", minHeight: "100vh" }}>
      <div style={{ maxWidth: 1240, margin: "0 auto" }}>
        ...
        <HeroEditorial category="Neighbourhood Guide" question="Best Airport for Central Paris: CDG, Orly or Beauvais?" subtitle="Your Paris neighbourhood — Right Bank, Left Bank, or central arrondissements — changes which airport is actually the best choice." metadata={{ readTime: "5 min read", reviewedDate: "Jul 2026", verified: true }}
          ...
          decisionIntelligence={{ state: "conditionally_recommended", recommendation: "Orly — for Left Bank and southern central Paris", summary: "Orly is recommended for many southern and Left Bank destinations. CDG remains competitive for northern Paris and when long-haul route availability constrains the choice.", advantages: ["Closest airport to central Paris — cheapest taxis (€35–40)","OrlyBus reaches Denfert-Rochereau in ~30 minutes","Best for Left Bank, Saint-Germain and the 5th-7th arrondissements"], tradeoffs: [{ advantage: "Proximity to central Paris", disadvantage: "No direct Métro or RER — requires Orlyval light rail or bus" },{ advantage: "Cheaper taxis than CDG", disadvantage: "Fewer long-haul and international routes than CDG" },{ advantage: "Compact terminal — less walking", disadvantage: "Right Bank and northern Paris are better served by CDG's RER B" }], flips: [{ condition: "Destination is northern arrondissement (8th, 9th, 18th)", result: "CDG becomes stronger — RER B and Roissybus serve these areas directly" },{ condition: "Flying long-haul or connecting internationally", result: "CDG may be required — most long-haul routes only operate from CDG" },{ condition: "Destination is Left Bank or southern central Paris (5th, 6th, 7th)", result: "Orly becomes the stronger recommendation" },{ condition: "Heavy road traffic during peak hours", result: "Orly's taxi distance advantage may disappear — rail from CDG becomes more predictable" }], limitations: [{ condition: "Public transport disruption", impact: "RER B or Orlyval service interruptions affect both airports" },{ condition: "Construction or major events", impact: "Transfer times may vary from published estimates" }], unknowns: ["Your exact arrondissement or street address","Whether your flight is long-haul, medium-haul or domestic","Your preferred transport method — taxi, rail, or bus","Your arrival time — traffic conditions vary dramatically by time of day"] }}
          evidence={{ factors: [
