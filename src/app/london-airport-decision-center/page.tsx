      ...
      <div style={{ maxWidth: 1240, margin: "0 auto" }}>
        ...
        <div className={styles.page}>
          ...
          <HeroEditorial
            ...
            decisionIntelligence={{ state: "conditionally_recommended", recommendation: "Heathrow — for most central London journeys", summary: "Heathrow is the general recommendation, but your London destination, airline, and budget can change the answer materially.", advantages: ["Three rail options to central London — the best-connected airport","Widest choice of airlines and international routes","Strongest overall transfer speed and reliability"], tradeoffs: [{ advantage: "Best rail connections", disadvantage: "Further from east and south London than alternatives" },{ advantage: "Most airlines and routes", disadvantage: "Typically higher ticket prices than budget airports" },{ advantage: "Best overall reliability", disadvantage: "Not the closest airport to any single central London area" }], flips: [{ condition: "Destination is Canary Wharf or Docklands", result: "London City becomes the stronger recommendation" },{ condition: "Destination is south London (Brixton, Croydon, Clapham)", result: "Gatwick becomes the better choice" },{ condition: "Priority is lowest airfare on a budget airline", result: "Stansted or Luton may become preferable" },{ condition: "Arrival is late at night", result: "Available transport can change the recommendation — JFK-style 24h Tube is unique to Heathrow" }], limitations: [{ condition: "Exact London destination unknown", impact: "Cannot determine which airport is geographically closest" },{ condition: "Airline not specified", impact: "Airline hubs constrain airport choice before transfer comparison" },{ condition: "Luggage and traveller profile", impact: "Families and business travellers value different trade-offs" }], unknowns: ["Exact London neighbourhood or postcode","Preferred airline or alliance","Arrival time and day of week","Checked baggage or hand luggage only","Public transport vs taxi preference"] }}
          evidence={{ factors: [
