    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 12, marginTop: 12 }}>
      ...
      {data.flips.length > 0 && (
        <div style={{ padding: "10px 14px", borderRadius: 6, border: "1px solid rgba(184,92,56,0.15)", background: "rgba(184,92,56,0.04)" }}>
          ...
          {data.flips.map((f, i) => (
            <div key={i} style={{ display: "flex", alignItems: "baseline", gap: 6, marginBottom: i < data.flips.length - 1 ? 6 : 0 }}>
      ...
      {data.unknowns && data.unknowns.length > 0 && (
        <div style={{ display: "flex", flexDirection: "column", gap: 3 }}>
          <span style={{ fontFamily: "var(--mono)", fontWeight: 600, fontSize: 8, letterSpacing: "0.06em", textTransform: "uppercase", color: "var(--pmuted)", opacity: 0.5 }}>
            Unknown
          </span>
